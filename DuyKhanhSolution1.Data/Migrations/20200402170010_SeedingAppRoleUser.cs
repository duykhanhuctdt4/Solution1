...
{
    public partial class SeedingAppRoleUser : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppUserUserLogin", x => x.UserId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    OrderDate = table.Column<DateTime>(nullable: false, defaultValue: new DateTime(2020, 4, 3, 0, 0, 9, 654, DateTimeKind.Local).AddTicks(4074)),
                    UserId = table.Column<Guid>(nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("f8483347-1086-458e-a0e7-5d9351503b1b"), "99c191ef-534b-40c4-b7ac-a61c98e7c562", "Administrator role", "admin", "admin" });

            migrationBuilder.InsertData(
                table: "AppUserRoles",
                columns: new[] { "UserId", "RoleId" },
                values: new object[] { new Guid("f8483347-1086-458e-a0e7-5d9351503b1b"), new Guid("f42202b3-0e97-431c-a703-0f164ee61d9e") });

            migrationBuilder.InsertData(
                table: "AppUsers",
                columns: new[] { "Id", "AccessFailedCount", "ConcurrencyStamp", "Dob", "Email", "EmailConfirmed", "FirstName", "LastName", "LockoutEnabled", "LockoutEnd", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "SecurityStamp", "TwoFactorEnabled", "UserName" },
                values: new object[] { new Guid("f42202b3-0e97-431c-a703-0f164ee61d9e"), 0, "df51a5db-8816-47bc-98bf-b64d52aaf53e", new DateTime(2020, 3, 3, 0, 0, 0, 0, DateTimeKind.Unspecified), "duykhanhdeveloper93@gmail.com", true, "Duy Khanh", "Pham", false, null, "duykhanhdeveloper93@gmail.com", "admin", "AQAAAAEAACcQAAAAEJochTNpapB2guq+tmPpYVDcNEWbTYSIhgEKwfQmjdqEA1dZKyOM5K9hy/KPmfatow==", null, false, "", false, "admin" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2020, 4, 3, 0, 0, 9, 668, DateTimeKind.Local).AddTicks(9862), 100000m, 200000m, null });
