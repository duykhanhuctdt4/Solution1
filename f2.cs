...
namespace Kyoto.GUI
{
    ...
    public partial class frmSelectWorkPiece : Form
    {
        ...
        private void Function_Event_DoNham_Multil(object sender, EventArgs e)
        {
            ...
            {
                if (getSelectedTextCombobox(getSelectedItemComboboxTxt(cbo)).Equals("2"))
                {
        ...
        private double All_Execute_A_vs_KTGC(int indexGroup, int indexRow, TextBox textInPut1, TextBox textInPut_KTGC1, TextBox textInPut_KTGC2, ComboBox cBoDoNham_1,
            ComboBox cBoDoNham_KTGC1, ComboBox cBoDoNham_KTGC2, ComboBox cboGiaCong6, ComboBox cboGiaCong7, TextBox textBoxOutPut1, TextBox textBoxOutPut_KTGC1,
            TextBox textBoxOutPut_KTGC2)
        {
            ...
            //=======Function convert======
            cboShape_StrIndex = cboShape_StrIndex.Replace("32", "02").Replace("33", "03").Replace("35", "05");
            ...
            //===========================================================================================================================
            if (textInPut1.Text.Equals(String.Empty) || textInPut_KTGC1.Text.Equals(String.Empty) /*|| textInPut_KTGC2.Text.Equals(String.Empty)*/)
            {
            ...
            if (cboShape_StrIndex.Equals("02") || cboShape_StrIndex.Equals("06"))
            {
                ...
                {
                    valueAjust1 = 1; // VỚI VẬT LIỆU CÓ TÊN CUỐI CÙNG LÀ -D9 THÌ LUÔN CỘNG LƯỢNG DƯ LÀ +1
                }
                else
                {
                    if (valueInput1 < 200) valueAjust1 = 2;//VỚI PHÔI HÌNH TRỤ CÓ ĐƯỜNG KÍNH LÀ NHỎ HƠN 200 THÌ LƯỢNG DƯ LÀ +2mm
                    if (valueInput1 >= 200) valueAjust1 = 3;//với đường kính từ φ200 trở lên thì lượng dư là +3mm
                }
            }
            ...
            valueAjust1_KTGC1 = this.RuleKTGC_for_A_KTGC(cboMaterial, cboShape, textInPut1, textBoxOutPut_KTGC1, cboGiaCong6);
            outputUltimateKTGC1 = valueInput_KTGC1 + valueAjust1_KTGC1;
            textBoxOutPut_KTGC1.Text = outputUltimateKTGC1.ToString();
            // Tính KÍCH THƯỚC GIA CÔNG 2 - CALCULATE SIZE KTGC2
            if (cboShape_StrIndex.Equals("05"))
            {
                valueAjust2_KTGC2 = this.RuleKTGC_for_A_KTGC(cboMaterial, cboShape, textInPut1, textBoxOutPut_KTGC2, cboGiaCong7);
                outputUltimateKTGC2 = valueInput_KTGC2 + valueAjust2_KTGC2;
            ...
            if (outputUltimate1 != -1 && outputUltimateKTGC1 != -1 /*&& outputUltimateKTGC2 != -1*/)
            {
                ...
                {
                    weighUltimate = khoiluongRieng * PI_NUMBER * outputUltimate1 * outputUltimateKTGC1;
                }
                if (cboShape_StrIndex.Equals("04"))
                {
                    weighUltimate = ((3 * Math.Sqrt(3)) / 2 * outputUltimate1 * (outputUltimate1 / 4) * outputUltimateKTGC1) / khoiluongRieng;
                }
                //if (cboShape_StrIndex.Equals("03"))
                //{
                //    weighUltimate = outputUltimate1 * outputUltimate1 * outputUltimateKTGC1 * khoiluongRieng;
                //}
                // MathRoundingRule
                weighUltimate = this.MathRoundingRule(weighUltimate);
                // Show result weigh
        ...
        private double RuleKTGC_for_A_KTGC(ComboBox cboMaterial, ComboBox cboShape, TextBox textInPut1, TextBox textInPut_KTGC, ComboBox cboDoNhamGC)
        {
            string cboShape_StrIndex = splitString(getSelectedTextCombobox(getSelectedItemComboboxTxt(cboShape)), ":", 0);
            string cboMaterial_StrIndex = splitString(getSelectedTextCombobox(getSelectedItemComboboxTxt(cboMaterial)), ":", 0);
            string cboMaterial_Raw = getSelectedTextCombobox(getSelectedItemComboboxTxt(cboMaterial));
            double valueInput1 = convertStringToDouble(textInPut1.Text);
            double valueDoNham = convertStringToDouble(getSelectedTextCombobox(getSelectedItemComboboxTxt(cboDoNhamGC)));
            double valueInput_KTGC = convertStringToDouble(textInPut_KTGC.Text);
            //=======Function convert======
                ...
                cboShape_StrIndex.Equals("04") || cboShape_StrIndex.Equals("34"))
            {
                ...
                {
                    string cbo_GiaCong_StrIndex6 = splitString(getSelectedTextCombobox(getSelectedItemComboboxTxt(cboDoNhamGC)), ":", 0);
                    if (cbo_GiaCong_StrIndex6.Equals("01"))
                    {
                        if (valueInput_KTGC <= 1000) return 3;
                        if (valueInput_KTGC > 1000 && valueInput_KTGC <= 1400) return 4;
                        if (valueInput_KTGC > 1400) return 5;
                    }
                    else if (cbo_GiaCong_StrIndex6.Equals("02")) //có gia công bậc và rỗng giữa
                    {
                        if (valueInput_KTGC <= 1000) return 4;
                        if (valueInput_KTGC > 1000) return 5;
                    }
                    else if (cbo_GiaCong_StrIndex6.Equals("03")) //có gia công bậc và rỗng giữa
                    {
                        return 5;
                    }
                    else
            ...
            if (cboShape_StrIndex.Equals("03") || cboShape_StrIndex.Equals("33"))
            {
                if (!cboMaterial_StrIndex.Equals("030")) // NGOẠI TRỪ A6063 CHO MÃ HÌNH DÁNG 03
                {
                    ...
                    if (valueDoNham == 2) // với mã hình dáng là 03 và tất cả các vật liệu ngoại trừ nhôm （A6063）một mặt +2 và 2 mặt tra bảng lượng dư cộng vào chiều dài
                    {
                        ...
                        {
                            if (valueInput_KTGC <= 300) return 3;
                            if (valueInput_KTGC > 300 && valueInput_KTGC <= 1400) return 4;
                            if (valueInput_KTGC > 1400) return 5;
                        }
                        if (valueInput1 > 50) // >50
                        {
                            if (valueInput_KTGC <= 200) return 3;
                            if (valueInput_KTGC > 200 && valueInput_KTGC <= 1000) return 4;
                            if (valueInput_KTGC > 1000) return 5;
                        }
                ...
                else
                {
                    ...
                    if (valueDoNham == 2) // với mã hình dáng là 03 và tất cả các vật liệu ngoại trừ nhôm （A6063）một mặt +2 và 2 mặt tra bảng lượng dư cộng vào chiều dài
                    {
                        ...
                        {
                            if (valueInput_KTGC <= 500) return 3;
                            if (valueInput_KTGC > 500 && valueInput_KTGC <= 1400) return 4;
                            if (valueInput_KTGC > 1400) return 5;
                        }
            ...
            if (cboShape_StrIndex.Equals("05") || cboShape_StrIndex.Equals("35"))
            {
                ...
                if (cboMaterial_StrIndex.Equals("030"))
                {
                    ...
                    //============30 <A≤90===========
                    if (valueInput1 > 30 && valueInput1 <= 90)
                    {
            ...
            ComboBox cBoDoNham_KTGC1, ComboBox cboGiaCong6, ComboBox cboGiaCong7, TextBox textBoxOutPut1, TextBox textBoxOutPut2, TextBox textBoxOutPut_KTGC1)
        {
                ...
                cboMaterial_StrIndex.Equals("030"))
            {
                ...
                {
                    if (valueDoNham1 == 1) // ĐỘ NHÁM  = 1
                    {
                        if (valueInput2 <= 50)
                        {
                            if (valueInput_KTGC1 <= 150) valueAjust1 = 1;
                            if (valueInput_KTGC1 > 150 && valueInput_KTGC1 <= 500) valueAjust1 = 2;
                            if (valueInput_KTGC1 > 500) valueAjust1 = 3;
                        }
                        //===================
                        if (valueInput2 > 50 && valueInput2 <= 100)
                        {
                            if (valueInput_KTGC1 <= 150) valueAjust1 = 1;
                            if (valueInput_KTGC1 > 150 && valueInput_KTGC1 <= 500) valueAjust1 = 2;
                            if (valueInput_KTGC1 > 500) valueAjust1 = 3;
                        ...
                        //===================
                        if (valueInput2 > 100 && valueInput2 <= 150)
                        {
                            if (valueInput_KTGC1 > 100 && valueInput_KTGC1 <= 500) valueAjust1 = 2;
                            if (valueInput_KTGC1 > 500) valueAjust1 = 3;
                        }
                        //===================
                        if (valueInput2 > 150 && valueInput2 <= 200)
                        {
                            if (valueInput_KTGC1 > 150 && valueInput_KTGC1 <= 500) valueAjust1 = 2;
                            if (valueInput_KTGC1 > 500) valueAjust1 = 3;
                        }
                    }
                    if (valueDoNham1 == 2) // ĐỘ NHÁM  = 2)
                    {
                        if (valueInput2 <= 50)
                        {
                            if (valueInput_KTGC1 <= 200) valueAjust1 = 2;
                            if (valueInput_KTGC1 > 200 && valueInput_KTGC1 <= 1000) valueAjust1 = 3;
                            if (valueInput_KTGC1 > 1000) valueAjust1 = 4;
                        }
                        //===================
                        if (valueInput2 > 50 && valueInput2 <= 100)
                        {
                        ...
                        if (valueInput2 > 100 && valueInput2 <= 150)
                        {
                            ...
                            if (valueInput_KTGC1 > 100 && valueInput_KTGC1 <= 200) valueAjust1 = 2;
                            if (valueInput_KTGC1 > 200 && valueInput_KTGC1 <= 1000) valueAjust1 = 3;
                            if (valueInput_KTGC1 > 1000) valueAjust1 = 4;
                        }
                        //===================
                        if (valueInput2 > 150 && valueInput2 <= 200)
                        {
                            if (valueInput_KTGC1 > 150 && valueInput_KTGC1 <= 200) valueAjust1 = 2;
                            if (valueInput_KTGC1 > 200 && valueInput_KTGC1 <= 1000) valueAjust1 = 3;
                            if (valueInput_KTGC1 > 1000) valueAjust1 = 4;
                        }
                    }
                ...
                cboMaterial_StrIndex.Equals("029"))
            {
                ...
                {
                    if (valueDoNham1 == 1 || valueDoNham1 == 2) // ĐỘ NHÁM  = 1
                    {
                        if (valueInput2 <= 50)
                        {
                            if (valueInput_KTGC1 <= 200) valueAjust1 = 2;
                            if (valueInput_KTGC1 > 200 && valueInput_KTGC1 <= 500) valueAjust1 = 3;
                            if (valueInput_KTGC1 > 500) valueAjust1 = 4;
                        }
                        ...
                        if (valueInput2 > 150 && valueInput2 <= 200)
                        {
                            if (valueInput_KTGC1 > 150 && valueInput_KTGC1 <= 500) valueAjust1 = 3;
                            if (valueInput_KTGC1 > 500) valueAjust1 = 4;
                        }

                        if (valueInput2 > 200 && valueInput2 <= 300)
                        {
                            if (valueInput_KTGC1 > 200 && valueInput_KTGC1 <= 500) valueAjust1 = 3;
                            if (valueInput_KTGC1 > 500) valueAjust1 = 4;
                        }
                        if (valueInput2 > 300 && valueInput2 <= 500)
                        {
                            if (valueInput_KTGC1 > 300 && valueInput_KTGC1 <= 500) valueAjust1 = 3;
                            if (valueInput_KTGC1 > 500) valueAjust1 = 4;
                        }
                        if (valueInput2 > 500 && valueInput2 <= 800)
                        {
                            if (valueInput_KTGC1 > 500 && valueInput_KTGC1 <= 1500) valueAjust1 = 4;
                            if (valueInput_KTGC1 > 1500) valueAjust1 = 5;
                        }
                        if (valueInput2 > 800 && valueInput2 <= 1000)
                        {
                            if (valueInput_KTGC1 > 500 && valueInput_KTGC1 <= 1000) valueAjust1 = 4;
                            if (valueInput_KTGC1 > 1000) valueAjust1 = 5;
                        }
                        if (valueInput2 > 1000 && valueInput2 <= 1500)
                        {
                            if (valueInput_KTGC1 > 1000) valueAjust1 = 5;
                        }
                    }
            ...
            if (cboShape_StrIndex.Equals("01") || cboShape_StrIndex.Equals("31") ||
                cboShape_StrIndex.Equals("07") || cboShape_StrIndex.Equals("37") ||
                cboShape_StrIndex.Equals("08") || cboShape_StrIndex.Equals("38") ||
                cboShape_StrIndex.Equals("12") || cboShape_StrIndex.Equals("42") ||
                cboShape_StrIndex.Equals("13") || cboShape_StrIndex.Equals("43") ||
                cboShape_StrIndex.Equals("16") || cboShape_StrIndex.Equals("46"))
            {
            ...
            if (cboShape_StrIndex.Equals("02") || cboShape_StrIndex.Equals("32") ||
                cboShape_StrIndex.Equals("04") || cboShape_StrIndex.Equals("34") ||
                cboShape_StrIndex.Equals("06") || cboShape_StrIndex.Equals("36"))
            {
                //Load Data cho trường công đoạn
                if (valueDoNham_KTGC1 == 1) valueAjust1_KTGC1 = 2; // cộng thêm 2mm KTGC, tham khảo mục số 2
                if (valueDoNham_KTGC1 == 2) // GIA CÔNG 2 MẶT THÌ TRA BẢNG lượng dư cộng vào chiều dà
                {
                    string cbo_GiaCong_StrIndex = splitString(getSelectedTextCombobox(getSelectedItemComboboxTxt(cboGiaCong6)), ":", 0);
                    if (cbo_GiaCong_StrIndex.Equals("01"))
                    {
                        if (valueInput_KTGC1 <= 1000) valueAjust1_KTGC1 = 3;
                        if (valueInput_KTGC1 > 1000 && valueInput_KTGC1 <= 1400) valueAjust1_KTGC1 = 4;
                        if (valueInput_KTGC1 > 1400) valueAjust1_KTGC1 = 5;
                    }
                    else if (cbo_GiaCong_StrIndex.Equals("02")) //có gia công bậc và rỗng giữa
                    {
                        if (valueInput_KTGC1 <= 1000) valueAjust1_KTGC1 = 4;
            ...
            if (cboShape_StrIndex.Equals("05") || cboShape_StrIndex.Equals("35"))
            {
                if (cboMaterial_StrIndex.Equals("002") || cboMaterial_StrIndex.Equals("013"))
                {
                    if (valueDoNham_KTGC1 == 1) valueAjust1_KTGC1 = 3; // cộng thêm 3mm KTGC, tham khảo mục số 6
                    if (valueDoNham_KTGC1 == 2)
                    {
                        if (valueInput2 <= 300) //~300
                        {
                            if (valueInput_KTGC1 <= 500) valueAjust1_KTGC1 = 5;
                            if (valueInput_KTGC1 > 500) valueAjust1_KTGC1 = 7;
                        }
                        if (valueInput2 > 300) //>300
                        {
                            if (valueInput_KTGC1 > 300 && valueInput_KTGC1 <= 500) valueAjust1_KTGC1 = 6;
                            if (valueInput_KTGC1 > 500) valueAjust1_KTGC1 = 7;
                        }
                    }
                }
                ...
                if (cboMaterial_StrIndex.Equals("004") || cboMaterial_Raw.Equals("SUS") || cboMaterial_StrIndex.Equals("075"))
                {
                    if (valueDoNham_KTGC1 == 1) valueAjust1_KTGC1 = 3; // cộng thêm 3mm KTGC, tham khảo mục số 7
                    if (valueDoNham_KTGC1 == 2) valueAjust1_KTGC1 = 5; // cộng thêm 5mm KTGC, tham khảo mục số 7
                ...
                if (cboMaterial_StrIndex.Equals("030"))
                {
                    if (valueInput1 <= 30)
                    {
                        ...
                        if (valueDoNham_KTGC1 == 2)
                        {
                            ...
                            if (valueInput2 > 100 && valueInput2 <= 300)
                            {
                                if (valueInput_KTGC1 <= 1000) valueAjust1_KTGC1 = 4;
                                if (valueInput_KTGC1 > 1000) valueAjust1_KTGC1 = 5;
                            }
                            if (valueInput2 > 300)
                            {
                                if (valueInput_KTGC1 > 300) valueAjust1_KTGC1 = 5;
                            }
                        }
                    }
                    //============30 <A≤90===========
                    if (valueInput1 > 30 && valueInput1 <= 90)
                    {
                        if (valueDoNham_KTGC1 == 1) valueAjust1_KTGC1 = 3;
                        if (valueDoNham_KTGC1 == 2)
                        {
                            if (valueInput2 <= 100)
                            {
                    ...
                    {
                        if (valueDoNham_KTGC1 == 1) valueAjust1_KTGC1 = 3;
                        if (valueDoNham_KTGC1 == 2) valueAjust1_KTGC1 = 5;
                    }
                }
            }
            ...
            if (outputUltimate1 != -1 && outputUltimate2 != -1 && outputUltimateKTGC1 != -1)
            {
                ...
                {
                    weighUltimate = khoiluongRieng * outputUltimateKTGC1 * (PI_NUMBER * outputUltimate1 - PI_NUMBER * (outputUltimate1 - 2 * outputUltimate2));
                }
                if (cboShape_StrIndex.Equals("07"))
                {
                    weighUltimate = khoiluongRieng * 4 * (outputUltimate1 - outputUltimate2);
                }
                if (cboShape_StrIndex.Equals("01"))
                {
                    weighUltimate = outputUltimate1 * outputUltimate2 * outputUltimateKTGC1;
                }
                // MathRoundingRule
                weighUltimate = this.MathRoundingRule(weighUltimate);
                // Show result weigh
            ...
            TextBox textBoxOutPut3, TextBox textBoxOutPut_KTGC1)
        {
            ...
            double valueDoNham1 = convertStringToDouble(getSelectedTextCombobox(getSelectedItemComboboxTxt(cBoDoNham_1)));
            double valueDoNham2 = convertStringToDouble(getSelectedTextCombobox(getSelectedItemComboboxTxt(cBoDoNham_2)));
            double valueDoNham3 = convertStringToDouble(getSelectedTextCombobox(getSelectedItemComboboxTxt(cBoDoNham_2)));
            double valueDoNham_KTGC1 = convertStringToDouble(getSelectedTextCombobox(getSelectedItemComboboxTxt(cBoDoNham_KTGC1)));
            ...
            if (outputUltimate1 != -1 && outputUltimate2 != -1 && outputUltimate3 != -1 && outputUltimateKTGC1 != -1)
            {
                ...
                {
                    weighUltimate = khoiluongRieng * outputUltimate1 * outputUltimate2 * (outputUltimate1 - 2 * outputUltimate3) * outputUltimateKTGC1;
                }
                if (cboShape_StrIndex.Equals("12"))
                {
                    weighUltimate = khoiluongRieng * outputUltimateKTGC1 * (outputUltimate1 * outputUltimate2 - (outputUltimate1 - 2 * outputUltimate3) * (outputUltimate2 - outputUltimate3));
                }
                if (cboShape_StrIndex.Equals("13"))
                {
                    weighUltimate = outputUltimate1 * outputUltimateKTGC1 * (outputUltimate2 * outputUltimate3 - (outputUltimate2 - outputUltimate1) * (outputUltimate3 - outputUltimate1));
                }
                // MathRoundingRule
                weighUltimate = this.MathRoundingRule(weighUltimate);
                // Show result weigh
            ...
            TextBox textBoxOutPut2, TextBox textBoxOutPut3, TextBox textBoxOutPut4, TextBox textBoxOutPut_KTGC1)
        {
            ...
            double valueDoNham2 = convertStringToDouble(getSelectedTextCombobox(getSelectedItemComboboxTxt(cBoDoNham_2)));
            double valueDoNham3 = convertStringToDouble(getSelectedTextCombobox(getSelectedItemComboboxTxt(cBoDoNham_2)));
            double valueDoNham4 = convertStringToDouble(getSelectedTextCombobox(getSelectedItemComboboxTxt(cBoDoNham_2)));
            double valueDoNham_KTGC1 = convertStringToDouble(getSelectedTextCombobox(getSelectedItemComboboxTxt(cBoDoNham_KTGC1)));
            ...
            if (outputUltimate1 != -1 && outputUltimate2 != -1 && outputUltimate3 != -1 && outputUltimateKTGC1 != -1)
            {
                ...
                weighUltimate = khoiluongRieng * outputUltimateKTGC1 * (2 * outputUltimate4 * outputUltimate2 + (outputUltimate1 - 2 * outputUltimate4 * outputUltimate3));
                // MathRoundingRule
                weighUltimate = this.MathRoundingRule(weighUltimate);
                // Show result weigh
                return weighUltimate;
        ...
        private double MathRoundingRule(double value)
        {
        ...
        private double TextRawForNumberTarget(string stringAnalyze, TextBox TextBoxPointer, TextBox TextBoxOutPut, double valueAjust, ComboBox cboMaterialCheck)
        {
            ...
            else if (cboMaterialStringRaw.Contains("S55C") || cboMaterialStringRaw.Contains("A2017") || cboMaterialStringRaw.Contains("SUS304TKHL")) // Trường  hợp 2 với vật kiệu đặc biệt
            {
                ...
                {
                    this.SearchIn__PAM(stringAnalyze, Count, valueDoubleTextBox, TextBoxOutPut, textBoxPAM_TC);
            ...
            {
                if (this.SearchIn__TIEUCHUAN(stringAnalyze, Count, valueDoubleTextBox, TextBoxOutPut, textBoxPAM_TC) == -1)
                {
                    if (this.SearchIn__PAM(stringAnalyze, Count, valueDoubleTextBox, TextBoxOutPut, textBoxPAM_TC) == -1)
                    {
                        TextBoxOutPut.Text = "NA. OVER DATA INPUT";
                        TextBoxOutPut.BackColor = Color.Red;
                        return -1;
        ...
        private void createNewRow_Input_Multil(int INDEX_GROUP)
        {
            try
            {
                ...
                if (panel_Determine != null)
                {
                    ...
                    //textBox1.Leave += new System.EventHandler(Funtion_All_Event_TextBox_txtBox_Leave_Multil);
                    //textBox2.Leave += new System.EventHandler(Funtion_All_Event_TextBox_txtBox_Leave_Multil);
                    //textBox3.Leave += new System.EventHandler(Funtion_All_Event_TextBox_txtBox_Leave_Multil);
                    //textBox4.Leave += new System.EventHandler(Funtion_All_Event_TextBox_txtBox_Leave_Multil);
                    //textBox5.Leave += new System.EventHandler(Funtion_All_Event_TextBox_txtBox_Leave_Multil);
                    //textBox6.Leave += new System.EventHandler(Funtion_All_Event_TextBox_txtBox_Leave_Multil);
                    //textBox7.Leave += new System.EventHandler(Funtion_All_Event_TextBox_txtBox_Leave_Multil);
            ...
            for (int i = 1; i <= rowListPanel[indexGroup]; i++)
            {
                    ...
                    cboShape_StrIndex.Equals("07") || cboShape_StrIndex.Equals("17"))
                {
                    ...
                    if (cboShape_StrIndex.Equals("01") || cboShape_StrIndex.Equals("31"))
                    {
                        ...
                        double weighIndex2 = this.All_Execute_A_B_vs_KTGC(indexGroup, i, textInPut1, textInPut_KTGC1, textInPut2, cBoDoNham_1, cBoDoNham_2, cBoDoNham_KTGC1,
                        cboGiaCong6, cboGiaCong7, textBoxOutPut1, textBoxOutPut2, textBoxOutPut_KTGC1);

                        double weighIndex3 = this.All_Execute_A_B_vs_KTGC(indexGroup, i, textInPut2, textInPut1, textInPut_KTGC1, cBoDoNham_1, cBoDoNham_2, cBoDoNham_KTGC1,
                        cboGiaCong6, cboGiaCong7, textBoxOutPut1, textBoxOutPut2, textBoxOutPut_KTGC1);

                        double weighIndex4 = this.All_Execute_A_B_vs_KTGC(indexGroup, i, textInPut2, textInPut_KTGC1, textInPut2, cBoDoNham_1, cBoDoNham_2, cBoDoNham_KTGC1,
                        cboGiaCong6, cboGiaCong7, textBoxOutPut1, textBoxOutPut2, textBoxOutPut_KTGC1);

                        double weighIndex5 = this.All_Execute_A_B_vs_KTGC(indexGroup, i, textBoxOutPut_KTGC1, textInPut1, textInPut2, cBoDoNham_1, cBoDoNham_2, cBoDoNham_KTGC1,
                        cboGiaCong6, cboGiaCong7, textBoxOutPut1, textBoxOutPut2, textBoxOutPut_KTGC1);

                        double weighIndex6 = this.All_Execute_A_B_vs_KTGC(indexGroup, i, textBoxOutPut_KTGC1, textInPut2, textInPut1, cBoDoNham_1, cBoDoNham_2, cBoDoNham_KTGC1,
                        cboGiaCong6, cboGiaCong7, textBoxOutPut1, textBoxOutPut2, textBoxOutPut_KTGC1);
                ...
                if (cboShape_StrIndex.Equals("02") || cboShape_StrIndex.Equals("32") ||
                    cboShape_StrIndex.Equals("03") || cboShape_StrIndex.Equals("33") ||
                    cboShape_StrIndex.Equals("05") || cboShape_StrIndex.Equals("35"))
                {
                    weighIndex = this.All_Execute_A_vs_KTGC(indexGroup, i, textInPut1, textInPut_KTGC1, textInPut_KTGC2, cBoDoNham_1, cBoDoNham_KTGC1, cBoDoNham_KTGC2, cboGiaCong6, cboGiaCong7,
        ...
        private void loadDataForAllDoNham(int index_Group, int RowIsLoaded)
        {
            ...
            List<string> listDoNham2 = new List<string>() { "0", "1", "2", "3", "4" };
